...
**Сценарий недееспособного основного владельца:**
1. При попытке доступа к питомцу с неактивным основным владельцем система показывает сообщение:
   "Обратитесь к основному владельцу или в службу поддержки."
2. Совладельцы могут обратиться в службу поддержки с официальным заявлением о недееспособности владельца
3. Администратор системы проверяет ситуацию и может:
   - Создать совладельца, которому передать права основного владельца
   - Назначить нового основного владельца из списка совладельцев
   - Передать права другому пользователю по заявке
   - Удалить питомца при подтверждении смерти/потери
4. Отправляются уведомления всем заинтересованным сторонам

**Критерии недееспособности:**
- Официальное обращение в поддержку о недееспособности владельца
- Длительное отсутствие активности владельца
- Подтверждение смерти или потери владельца

**Примечание:** Данная функциональность планируется к реализации в будущих версиях системы (API эндпоинт `/api/pets/{id}/leave/`, логика проверки единственного владельца, уведомления, система тикетов поддержки).
...
**Автоматическое завершение записей**: Глобальные настройки для автоматического завершения бронирований со статусом 'pending_confirmation' через определенный период времени. Включает уведомления участникам и детальную отчетность по автоматическим завершениям для анализа эффективности системы.
...
5. Показывается доступность записи/услуг
...
1. Система собирает данные из всех модулей
2. Агрегирует статистику по периодам
3. Формирует графики и диаграммы
4. Экспортирует отчеты в PDF/Excel
5. Отправляет регулярные отчеты

### 11.2 Аналитика пользователей

**Метрики пользователей:**
- Активность по дням/неделям/месяцам
- Популярные услуги и учреждения
...
**Модерация контента:**
- Проверка отзывов и комментариев
- Модерация объявлений учреждений
