...
### Высокий приоритет
1. **Необходимо получить API ключ для Google Perspective API и завершить интеграцию модерации отзывов**
2. **Требуется протестировать и настроить систему модерации через Perspective API**
3. **Перенести настройки Perspective в .env**
4. **Отсутствует фильтрация питомцев при поиске на передержку**
...
#### Необходимо получить API ключ для Google Perspective API и завершить интеграцию модерации отзывов
