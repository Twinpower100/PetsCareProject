...
### Средний приоритет
1. **ГЭП 6.7: Необходимо убрать автоматическую разблокировку по прошествии времени**
2. **Отсутствует система обнаружения попыток взлома**
3. **Отсутствует система политик безопасности и их мониторинга**
