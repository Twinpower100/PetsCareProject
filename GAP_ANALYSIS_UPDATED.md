...
### Высокий приоритет
1. **Отсутствует назначение ситтера владельцем питомца на время передержки**
2. **Отсутствует чат между владельцем питомца и пет-ситтером**
3. **Отсутствует самостоятельное снятие обязанностей совладельца**
4. **Отсутствует система обработки недееспособности владельцев**
5. **Отсутствует расширенная фильтрация питомцев**
6. **Отсутствует фильтрация питомцев при поиске на передержку**
...
1. **Жестко заданный русский язык в геолокации** - ✅ **ГЭП ЗАКРЫТ**
2. **Автоматическая блокировка учреждений** - ✅ **ГЭП ЗАКРЫТ**
