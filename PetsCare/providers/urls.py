...
urlpatterns = [
    ...
    path('providers/<int:provider_id>/partnership/pause/', api_views.ProviderPartnershipPauseAPIView.as_view(), name='provider-partnership-pause'),
    path('providers/<int:provider_id>/partnership/terminate/', api_views.ProviderPartnershipTerminateAPIView.as_view(), name='provider-partnership-terminate'),
    path('providers/<int:provider_id>/partnership/reactivate/', api_views.ProviderPartnershipReactivateAPIView.as_view(), name='provider-partnership-reactivate'),
    path('providers/<int:provider_id>/locations/reactivate-bulk/', api_views.ProviderLocationBulkReactivateAPIView.as_view(), name='provider-location-reactivate-bulk'),
    ...
    path('providers/<int:provider_id>/price-matrix/', api_views.ProviderPriceMatrixAPIView.as_view(), name='provider-price-matrix'),
    path('providers/<int:provider_id>/pricing-settings/', api_views.ProviderPricingSettingsAPIView.as_view(), name='provider-pricing-settings'),
    path('providers/<int:provider_id>/services/<int:service_id>/prices/', api_views.ProviderServicePricesUpdateAPIView.as_view(), name='provider-service-prices-update'),
    path('providers/<int:provider_id>/catalog-service/<int:service_id>/prices/', api_views.ProviderCatalogServicePricesUpdateAPIView.as_view(), name='provider-catalog-service-prices-update'),
    ...
    path('providers/<int:provider_id>/locations/<int:location_id>/temporary-close/', api_views.ProviderLocationTemporaryCloseAPIView.as_view(), name='provider-location-temporary-close'),
    path('providers/<int:provider_id>/locations/<int:location_id>/deactivate/', api_views.ProviderLocationDeactivateAPIView.as_view(), name='provider-location-deactivate'),
    path('providers/<int:provider_id>/locations/<int:location_id>/reactivate/', api_views.ProviderLocationReactivateAPIView.as_view(), name='provider-location-reactivate'),
