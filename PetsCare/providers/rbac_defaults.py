...
RESOURCE_DEFINITIONS = [
    ...
    {'code': 'org.services', 'name': 'Organization Services Pricing', 'description': 'Organization-level unified pricing matrix.', 'parent_code': 'org', 'sort_order': 25},
    ...
    {'code': 'locations.deactivation', 'name': 'Location Deactivation', 'description': 'Branch temporary close, deactivation, and reactivation controls.', 'parent_code': 'locations', 'sort_order': 35},
...
PERMISSION_MATRIX = {
    'owner': {
        ...
        'org.services': _matrix_entry('CRUD'),
        ...
        'locations.deactivation': _matrix_entry('D'),
    ...
    'branch_manager': {
        ...
        'locations.deactivation': _matrix_entry('D', ProviderRolePermission.SCOPE_OWN_BRANCH),
